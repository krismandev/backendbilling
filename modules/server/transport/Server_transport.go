...
import (
	...
	dt "billingdashboard/modules/server/datastruct"
	"context"
	"encoding/json"
	"io/ioutil"
	"net/http"
...
// ServerDecodeRequest is use for ...
func ServerDecodeRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	var request dt.ServerRequest
...
// ServerListEncodeResponse is use for ...
func ServerListEncodeResponse(ctx context.Context, w http.ResponseWriter, response interface{}) error {
...
// ServerSingleEncodeResponse is use for ...
func ServerSingleEncodeResponse(ctx context.Context, w http.ResponseWriter, response interface{}) error {
	body, err := json.Marshal(&response)
	core.LogBodyRequest(body, "Send Response")
