...
import (
	...
	dt "billingdashboard/modules/server-account/datastruct"
	"billingdashboard/modules/server-account/services"
	"context"
	"errors"
...
// ListServerAccountEndpoint is as request middleware
...
// CreateServerAccountEndpoint is as request middleware
func CreateServerAccountEndpoint(conn *connections.Connections) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		if req, ok := request.(dt.ServerAccountRequest); ok {
			return services.CreateServerAccount(ctx, req, conn), nil
		}
...
// UpdateServerAccountEndpoint is as request middleware
func UpdateServerAccountEndpoint(conn *connections.Connections) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		var errResp core.GlobalSingleResponse
		errNoJWT, errJWT := core.HandleJWT(ctx)
		if errJWT != nil {
		...
		if req, ok := request.(dt.ServerAccountRequest); ok {
			return services.UpdateServerAccount(ctx, req, conn), nil
		}
...
// DeleteServerAccountEndpoint is as request middleware
func DeleteServerAccountEndpoint(conn *connections.Connections) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		var errResp core.GlobalSingleResponse
		errNoJWT, errJWT := core.HandleJWT(ctx)
		if errJWT != nil {
		...
		if req, ok := request.(dt.ServerAccountRequest); ok {
			return services.DeleteServerAccount(ctx, req, conn), nil
		}
