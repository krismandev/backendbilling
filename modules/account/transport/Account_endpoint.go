...
import (
	...
	"billingdashboard/modules/account/services"
	"context"
	"errors"
...
func ListAccountEndpoint(conn *connections.Connections) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		if req, ok := request.(dt.AccountRequest); ok {
			return services.ListAccount(ctx, req, conn), nil
		}
...
// ListAccountEndpoint is as request middleware
func ListRootAccountEndpoint(conn *connections.Connections) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		var errResp core.GlobalListResponse
		errNoJWT, errJWT := core.HandleJWT(ctx)
		if errJWT != nil {
		...
		if req, ok := request.(dt.AccountRequest); ok {
			return services.ListRootAccount(ctx, req, conn), nil
		}
...
// CreateAccountEndpoint is as request middleware
func CreateAccountEndpoint(conn *connections.Connections) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		if req, ok := request.(dt.AccountRequest); ok {
			return services.CreateAccount(ctx, req, conn), nil
		}
...
// UpdateAccountEndpoint is as request middleware
func UpdateAccountEndpoint(conn *connections.Connections) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		var errResp core.GlobalSingleResponse
		errNoJWT, errJWT := core.HandleJWT(ctx)
		if errJWT != nil {
		...
		if req, ok := request.(dt.AccountRequest); ok {
			return services.UpdateAccount(ctx, req, conn), nil
		}
...
// DeleteAccountEndpoint is as request middleware
func DeleteAccountEndpoint(conn *connections.Connections) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		var errResp core.GlobalSingleResponse
		errNoJWT, errJWT := core.HandleJWT(ctx)
		if errJWT != nil {
		...
		if req, ok := request.(dt.AccountRequest); ok {
			return services.DeleteAccount(ctx, req, conn), nil
		}
